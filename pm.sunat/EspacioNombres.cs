...
namespace pm.sunat
{
    public class EspacioNombres
    {
        ...
        public const string xmlnsGuia = "urn:oasis:names:specification:ubl:schema:xsd:DespatchAdvice-2";
        ...
        public const string CommonExtensionComponents = "urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2";
    }
}
