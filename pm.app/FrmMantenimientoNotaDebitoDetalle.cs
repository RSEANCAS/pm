...
namespace pm.app
{
    public partial class FrmMantenimientoNotaDebitoDetalle : RadForm
    {
        public List<NotaDebitoDetalleBe> ListaDetalleInicial { get; set; }
        public List<NotaDebitoDetalleBe> ListaDetalleActual { get; set; }
        NotaDebitoDetalleBe _Detalle;
        public NotaDebitoDetalleBe Detalle { get { return _Detalle; } }
        ...
        public FrmMantenimientoNotaDebitoDetalle(NotaDebitoDetalleBe item = null)
        {
            InitializeComponent();
            _Detalle = item;
        }

        private void FrmMantenimientoNotaDebitoDetalle_Load(object sender, EventArgs e)
        {
            Text = Detalle == null ? "Agregar Registro" : "Modificar Registro";
            ListarCombos();
            if (Detalle != null)
            {
                CargarNotaDebitoDetalle();
            }
        }

        void CargarNotaDebitoDetalle()
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            _Detalle = _Detalle ?? new NotaDebitoDetalleBe();

            //_Detalle.CodigoNotaDebitoDetalle = 0;
        ...
        {
            tltNotaDebitoDetalle.SetToolTip(label, label.Text);
        }
    }
}
