...
namespace pm.app
{
    public partial class FrmMantenimientoFacturaVentaDetalle : RadForm
    {
        public List<FacturaVentaDetalleBe> ListaDetalleInicial { get; set; }
        public List<FacturaVentaDetalleBe> ListaDetalleActual { get; set; }
        FacturaVentaDetalleBe _Detalle;
        public FacturaVentaDetalleBe Detalle { get { return _Detalle; } }
        ...
        public FrmMantenimientoFacturaVentaDetalle(FacturaVentaDetalleBe item = null)
        {
            InitializeComponent();
            _Detalle = item;
        }

        private void FrmMantenimientoFacturaVentaDetalle_Load(object sender, EventArgs e)
        {
            Text = Detalle == null ? "Agregar Registro" : "Modificar Registro";
            ListarCombos();
            if (Detalle != null)
            {
                CargarFacturaVentaDetalle();
            }
        }

        void CargarFacturaVentaDetalle()
        {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            _Detalle = _Detalle ?? new FacturaVentaDetalleBe();

            //_Detalle.CodigoFacturaVentaDetalle = 0;
        ...
        bool ValidarFormulario()
        {
            ...
            {
                ListaDetalleActual = ListaDetalleActual ?? new List<FacturaVentaDetalleBe>();

                int? codigoFacturaVentaDetalle = Detalle == null ? null : (int?)Detalle.CodigoFacturaVentaDetalle;

                bool existeProductoIndividual = ListaDetalleActual.Count(x => x.CodigoProductoIndividual == codigoProductoIndividual && x.CodigoFacturaVentaDetalle != codigoFacturaVentaDetalle) > 0;
        ...
        {
            tltFacturaVentaDetalle.SetToolTip(label, label.Text);
        }
    }
}
