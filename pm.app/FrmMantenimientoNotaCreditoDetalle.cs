...
namespace pm.app
{
    public partial class FrmMantenimientoNotaCreditoDetalle : RadForm
    {
        public List<NotaCreditoDetalleBe> ListaDetalleInicial { get; set; }
        public List<NotaCreditoDetalleBe> ListaDetalleActual { get; set; }
        NotaCreditoDetalleBe _Detalle;
        public NotaCreditoDetalleBe Detalle { get { return _Detalle; } }
        ...
        private void FrmMantenimientoNotaCreditoDetalle_Load(object sender, EventArgs e)
        {
            Text = Detalle == null ? "Agregar Registro" : "Modificar Registro";
            ListarCombos();
            if (Detalle != null)
            {
                CargarNotaCreditoDetalle();
            }
        }

        void CargarNotaCreditoDetalle()
        {
        ...
        bool ValidarFormulario()
        {
            ...
            {
                ListaDetalleActual = ListaDetalleActual ?? new List<NotaCreditoDetalleBe>();

                int? codigoNotaCreditoDetalle = Detalle == null ? null : (int?)Detalle.CodigoNotaCreditoDetalle;

                bool existeProductoIndividual = ListaDetalleActual.Count(x => x.CodigoProductoIndividual == codigoProductoIndividual && x.CodigoNotaCreditoDetalle != codigoNotaCreditoDetalle) > 0;
        ...
        {
            tltNotaCreditoDetalle.SetToolTip(label, label.Text);
        }
    }
}
